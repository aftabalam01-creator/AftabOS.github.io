...
const T = {
  en: {
    ...
    t1quote:"Before this system, tracking a shipment from China to Kabul meant a dozen phone calls and a lot of guessing. Now I can see exactly where every truck is, what's arrived, and what customers still owe, all in one place, in my own language. It's changed how we run the business.",
    t1name:'Noor Alamyar', t1role:'Director, Modern Silk Road Freights',
  ...
  fa: {
    ...
    t1quote:'قبل از این سیستم، ردیابی یک محموله از چین به کابل به دوازده تماس تلفنی و خیلی حدس‌وگمان نیاز داشت. حالا می‌توانم ببینم هر کامیون کجاست، چه چیزی رسیده، و مشتریان چقدر بدهی دارند — در یک جا، به زبان خودم. روش اداره کسب‌وکار ما را تغییر داده است.',
    t1name:'نور آلمیار', t1role:'مدیر، جاده ابریشم مدرن فریتس',
  ...
  ps: {
    ...
    t1quote:'د دې سیستم نه دمخه، د چین نه کابل ته د یوه محموله ردیابي د دولسو فونو زنګونو او خورا ډیرو اټکلونو ته اړتیا درلوده. اوس زه سمدلاسه لیدلای شم چې هر ټرک چیرته دی، څه رارسیدلي، او پیرودونکو ته به څومره پوروي — یو ځای، زما د خپل ژبې کې. د سوداګرۍ د چلولو طریقه مو بدله کړه.',
    t1name:'نور آلمیار', t1role:'مدیر، مدرن د ابریشم لار فریتس',
  ...
  zh: {
    ...
    t1quote:'在这套系统出现之前，追踪一票从中国到喀布尔的货物需要打十几个电话、全靠猜测。现在我能在一个地方、用我自己的语言，看到每辆货车的实时位置、已到货物和客户欠款。它彻底改变了我们管理业务的方式。',
    t1name:'Noor Alamyar', t1role:'总监，Modern Silk Road Freights',
  ...
  ar: {
    ...
    t1quote:'قبل هذا النظام، كان تتبع شحنة واحدة من الصين إلى كابول يتطلب عشرات المكالمات الهاتفية والكثير من التخمين. الآن أستطيع أن أرى بالضبط أين كل شاحنة، وما الذي وصل، وما الذي لا يزال مديناً به العملاء — في مكان واحد، بلغتي. لقد غيّر طريقة إدارتنا للأعمال.',
    t1name:'نور آلمیار', t1role:'مدير، Modern Silk Road Freights',
