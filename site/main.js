...
const T = {
  en: {
    ...
    t1quote:"Before this system, tracking a shipment from China to Kabul meant a dozen phone calls and a lot of guessing. Now I can see exactly where every truck is, what's arrived, and what customers still owe — in one place, in my own language. It's changed how we run the business.",
