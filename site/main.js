...
const T = {
  en: {
    ...
    whySub:'We bring American engineering discipline to the Afghan market. We understand both worlds from the inside.',
    ...
    waCtaEyebrow:'Preferred Contact', waCtaHeading:'Most Afghan clients reach us on WhatsApp',
    ...
    footerTagline:"Engineering Afghanistan's Digital Future, from Miami to Dubai.",
  ...
  fa: {
    ...
    waCtaEyebrow:'روش ترجیحی تماس', waCtaHeading:'اکثر مشتریان افغان از طریق واتساپ با ما تماس می‌گیرند',
    ...
    footerTagline:'آینده دیجیتال افغانستان را از میامی تا دبی مهندسی می‌کنیم.',
  ...
  ps: {
    ...
    waCtaEyebrow:'غوره اړیکه', waCtaHeading:'ډیری افغان پیرودونکي زموږ سره واټساپ کې اړیکه نیسي',
    ...
    footerTagline:'د افغانستان ډیجیټل راتلونکی د میامي نه دوبۍ ته انجینیري کوو.',
  ...
  ar: {
    ...
    waCtaEyebrow:'طريقة التواصل المفضلة', waCtaHeading:'معظم العملاء الأفغان يتواصلون معنا عبر واتساب',
    ...
    footerTagline:'نهندس مستقبل أفغانستان الرقمي — من ميامي إلى دبي.',
